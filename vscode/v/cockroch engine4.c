...
{ 
 ...
 if(button == GLUT_LEFT_BUTTON && state == GLUT_DOWN) 
 {
  ...
  if(x/8>=104)
  {
   if(y/8<16+8*0){ currentTexture+=1; if(currentTexture>7){ currentTexture=0;}} //next texture
...
{int x,y,i,j;
 ...
 glColor3f(0,0,0);
 drawText(840, 154, "Save");
 drawText(840, 154+64, "Load");
 drawText(840, 154+128, "Player");
 drawText(840, 154+192, "Enemy");
 drawText(840, 154+256, "Walls");
 drawText(840, 154+320, "Floors");
 drawText(840, 154+384, "Ceiling");
 drawText(840, 154+448, "Play");
...
void screen(int v) //draw any full screen image. 120x80 pixels
{
 ...
 //int *T;
 int r,g,b;
 if(v==1){ r=0; g=0; b=255;} //title screen - blue
